package br.edu.ifms.ed.constant;
...
public class Textual {
    ...
    public static final String CADASTRAR_ALUNO = "Cadastrar Student";
    public static final String CADASTRAR_NOTA = "Cadastrar Nota";
    public static final String CONSULTAR_ALUNO = "Consultar Student";
    public static final String EXIBIR_ALUNOS = "Exibir Alunos";
    public static final String EXIBIR_ALUNOS_TOOLTIP = "Clique aqui para exibir os alunos";
    public static final String CONSULTAR_ALUNO_TOOLTIP = "Clique aqui para consultar por um aluno";
    public static final String CADASTRAR_NOTA_TOOLTIP = "Clique aqui para cadastrar uma nota";
    ...
    public static final String ALUNO_NAO_ENCONTRADO = "Student não encontrado";
    ...
    public static final String NOTA_CADASTRADA = "Nota cadastrada";
    public static final String DIGITE_CODIGO_ALUNO = "Digite um código para aluno: ";
    ...
    public static final String ALUNO_CADASTRADO = "Student cadastrado";
    ...
    public static final String ALUNO_EXCLUIDO = "Student excluído";
