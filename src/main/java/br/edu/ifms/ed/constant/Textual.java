...
public class Textual {
    ...
    public static final String CALCULAR_MEDIA = "Calcular media";
    ...
    public static final String CONSULTAR_ALUNO = "Consultar Aluno";
    ...
    public static final String MEDIA_ALUNO = "Media do aluno: ";
    public static final String MEDIA_ALUNOS = "Media dos alunos: ";
